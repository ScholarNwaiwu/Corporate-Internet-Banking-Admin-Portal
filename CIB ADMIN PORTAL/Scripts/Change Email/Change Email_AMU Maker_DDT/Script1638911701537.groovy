...
WebUI.setText(findTestObject('Object Repository/Change Email/input_User Name_txtUserName'), Username)

WebUI.setText(findTestObject('Object Repository/Change Email/input_Password_txtPassword'), Password)

WebUI.setText(findTestObject('Object Repository/Change Email/input_Token_txtToken'), Token)
...
WebUI.setText(findTestObject('Object Repository/Change Email/input_Customer Name_ctl00ContentPlaceHolder_f4b4c6'), Customer_Name)
...
WebUI.setText(findTestObject('Object Repository/Change Email/input_New Email Address_ctl00ContentPlaceHo_2e77ea'), New_Email_Address)
